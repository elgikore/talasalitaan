...
Weird spacing like "  " is corrected (" "), tab spaces are stripped, unicode elipsis ("…") is expanded to "...", and the "/"'s in *Sabayang Pagbigkas* are removed because it is frequently occuring, which might bias the BPE. All upper and lowercase are preserved. Line numbers in poems and Florante at Laura are removed.
